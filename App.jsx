...
import PetInfoScreen from './src/screens/PetInfoScreen';                // ✅ 추가
...
const tabScreens = [
  ...
  { name: '홈', component: HomeStackScreen }, // ✅ 홈 탭을 스택으로 교체
  ...
  return (
    <NavigationContainer>
      <RootStack.Navigator initialRouteName="LoginMain">
        ...
        {/* ⛔️ PetInfoScreen은 HomeStack에 있으므로 루트에 등록하지 않음 */}
      </RootStack.Navigator>
    </NavigationContainer>
  );
};
